...
//		profile1.setUserName("Lily");
		...
		Job job1 = new Job(com1, "Software Engineer Intern",
				"https://paypal.eightfold.ai/careers?Codes=W-LINKEDIN&domain=paypal.com&query=R0111038&sort_by=relevance");
		Job job2 = new Job(com2, "Software Engineering Intern, People with Disabilities 2024",
				"https://www.google.com/about/careers/applications/jobs/results/133383757286515398-software-engineering-intern-people-with-disabilities-2024");
		Job job3 = new Job(com3, "AIML - Software Engineering Internship - Multiple Party Computation, MLPT",
				"https://jobs.apple.com/en-us/details/200519066/aiml-software-engineering-internship-multiple-party-computation-mlpt?team=STDNT");
		Job job4 = new Job(com4, "Software Development Intern",
				"https://builtin.com/job/software-development-intern/110908");
		// Create additional jobs and applications for the first company
		Job job5 = new Job(com1, "Software Engineer",
				"https://paypal.eightfold.ai/careers?Codes=W-LINKEDIN&domain=paypal.com&query=R0111039&sort_by=relevance");
		Job job6 = new Job(com1, "Data Scientist Intern",
				"https://paypal.eightfold.ai/careers?Codes=W-LINKEDIN&domain=paypal.com&query=R0111040&sort_by=relevance");
		...
		Job job8 = new Job(com6, "Software Engineering Intern (Summer 2024)",
				"https://sedarotech.bamboohr.com/careers/38");
